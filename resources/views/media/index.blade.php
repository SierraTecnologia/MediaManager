    ...
    <div class="page-content container-fluid">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div id="filemanager">
                    <media-manager
                        base-path="{{ \Illuminate\Support\Facades\Config::get('admin.media-manager.media.path', '/') }}"
                        :show-folders="{{ \Illuminate\Support\Facades\Config::get('admin.media-manager.media.show_folders', true) ? 'true' : 'false' }}"
                        :allow-upload="{{ \Illuminate\Support\Facades\Config::get('admin.media-manager.media.allow_upload', true) ? 'true' : 'false' }}"
                        :allow-move="{{ \Illuminate\Support\Facades\Config::get('admin.media-manager.media.allow_move', true) ? 'true' : 'false' }}"
                        :allow-delete="{{ \Illuminate\Support\Facades\Config::get('admin.media-manager.media.allow_delete', true) ? 'true' : 'false' }}"
